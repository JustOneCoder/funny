package com.flf.funny.service.config.disklrucache;
...
public class DiskCacheManager {
    ...
    public DiskCacheManager(Context context, String uniqueName) {
        try {
            ...
            mDiskLruCache = DiskLruCache.open(cacheFile, FunnyApplication.getAppVersionCode(), 1, Constants.CACHE_MAXSIZE);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
